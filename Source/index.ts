 ...
 * All known qualities.
 */
export const allQualities: ReadonlySet<Quality> = new Set(
 ...
 */
export const isQuality = (input: string): input is Quality =>
	allQualities.has(input as Quality);
...
export interface IBrowserFinder {
	 ...
	 */
	findWhere(
		predicate: (exe: IExecutable) => boolean,
